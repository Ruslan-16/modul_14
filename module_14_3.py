...
async def get_buying_list(message: types.Message):
    products = [
        {'name': 'Product1', 'description': 'Описание продукта 1', 'price': 100, 'image': 'product1.jpg'},
        {'name': 'Product2', 'description': 'Описание продукта 2', 'price': 200, 'image': 'product2.jpg'},
        {'name': 'Product3', 'description': 'Описание продукта 3', 'price': 300, 'image': 'product3.jpg'},
        {'name': 'Product4', 'description': 'Описание продукта 4', 'price': 400, 'image': 'product4.jpg'},
    ]

    for product in products:
        text = f"Название: {product['name']} | Описание: {product['description']} | Цена: {product['price']} ₽"
        try:
